...
import com.mobile.tracker_domain.use_case.*
import com.mobile.tracker_presentation.search.SearchScreen
import com.mobile.tracker_presentation.search.SearchViewModel
import com.mobile.tracker_presentation.tracker_overview.TrackerOverviewScreen
import com.mobile.tracker_presentation.tracker_overview.TrackerOverviewViewModel
...
class TrackerOverviewE2E {
    ...
    fun setUp() {
        ...
        trackerOverviewViewModel = TrackerOverviewViewModel(
            ...
            trackerUserCase = trackerUseCases
        )
    ...
    @Test
    fun add_breakfast_appears_under_breakfast_nutrients_properly_calculated() {
